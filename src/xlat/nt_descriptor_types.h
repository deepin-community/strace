...
static const struct xlat_data nt_descriptor_types_xdata[] = {
 ...
 XLAT(NT_METAG_CBUF),
 #define XLAT_VAL_70 ((unsigned) (NT_METAG_CBUF))
 #define XLAT_STR_70 STRINGIFY(NT_METAG_CBUF)
 XLAT(NT_METAG_RPIPE),
 #define XLAT_VAL_71 ((unsigned) (NT_METAG_RPIPE))
 #define XLAT_STR_71 STRINGIFY(NT_METAG_RPIPE)
 XLAT(NT_METAG_TLS),
 #define XLAT_VAL_72 ((unsigned) (NT_METAG_TLS))
 #define XLAT_STR_72 STRINGIFY(NT_METAG_TLS)
 XLAT(NT_ARC_V2),
 #define XLAT_VAL_73 ((unsigned) (NT_ARC_V2))
 #define XLAT_STR_73 STRINGIFY(NT_ARC_V2)
 XLAT(NT_VMCOREDD),
 #define XLAT_VAL_74 ((unsigned) (NT_VMCOREDD))
 #define XLAT_STR_74 STRINGIFY(NT_VMCOREDD)
 XLAT(NT_MIPS_DSP),
 #define XLAT_VAL_75 ((unsigned) (NT_MIPS_DSP))
 #define XLAT_STR_75 STRINGIFY(NT_MIPS_DSP)
 XLAT(NT_MIPS_FP_MODE),
 #define XLAT_VAL_76 ((unsigned) (NT_MIPS_FP_MODE))
 #define XLAT_STR_76 STRINGIFY(NT_MIPS_FP_MODE)
 XLAT(NT_MIPS_MSA),
 #define XLAT_VAL_77 ((unsigned) (NT_MIPS_MSA))
 #define XLAT_STR_77 STRINGIFY(NT_MIPS_MSA)
 XLAT(NT_RISCV_CSR),
 #define XLAT_VAL_78 ((unsigned) (NT_RISCV_CSR))
 #define XLAT_STR_78 STRINGIFY(NT_RISCV_CSR)
 XLAT(NT_RISCV_VECTOR),
 #define XLAT_VAL_79 ((unsigned) (NT_RISCV_VECTOR))
 #define XLAT_STR_79 STRINGIFY(NT_RISCV_VECTOR)
 XLAT(NT_LOONGARCH_CPUCFG),
 #define XLAT_VAL_80 ((unsigned) (NT_LOONGARCH_CPUCFG))
 #define XLAT_STR_80 STRINGIFY(NT_LOONGARCH_CPUCFG)
 XLAT(NT_LOONGARCH_CSR),
 #define XLAT_VAL_81 ((unsigned) (NT_LOONGARCH_CSR))
 #define XLAT_STR_81 STRINGIFY(NT_LOONGARCH_CSR)
 XLAT(NT_LOONGARCH_LSX),
 #define XLAT_VAL_82 ((unsigned) (NT_LOONGARCH_LSX))
 #define XLAT_STR_82 STRINGIFY(NT_LOONGARCH_LSX)
 XLAT(NT_LOONGARCH_LASX),
 #define XLAT_VAL_83 ((unsigned) (NT_LOONGARCH_LASX))
 #define XLAT_STR_83 STRINGIFY(NT_LOONGARCH_LASX)
 XLAT(NT_LOONGARCH_LBT),
 #define XLAT_VAL_84 ((unsigned) (NT_LOONGARCH_LBT))
 #define XLAT_STR_84 STRINGIFY(NT_LOONGARCH_LBT)
 XLAT(NT_FILE),
 #define XLAT_VAL_85 ((unsigned) (NT_FILE))
 #define XLAT_STR_85 STRINGIFY(NT_FILE)
 XLAT(NT_PRXFPREG),
 #define XLAT_VAL_86 ((unsigned) (NT_PRXFPREG))
 #define XLAT_STR_86 STRINGIFY(NT_PRXFPREG)
 XLAT(NT_SIGINFO),
 #define XLAT_VAL_87 ((unsigned) (NT_SIGINFO))
 #define XLAT_STR_87 STRINGIFY(NT_SIGINFO)
};
static
